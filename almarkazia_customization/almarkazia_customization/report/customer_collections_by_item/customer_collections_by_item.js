frappe.query_reports["Customer Collections by Item"] = {
	...
	filters: [
		...
		},
		{
			...
			fieldtype: "Select",
			options: [
				{ value: "Detailed View", label: __("عرض تفصيلي") },
				{ value: "Summary View", label: __("عرض ملخص") },
			],
			default: "Detailed View",
			reqd: 1,
		},
		{ fieldname: "customer", label: __("العميل"), fieldtype: "Link", options: "Customer" },
		{ fieldname: "item", label: __("الصنف"), fieldtype: "Link", options: "Item" },
		{ fieldname: "item_group", label: __("مجموعة الصنف"), fieldtype: "Link", options: "Item Group" },
		{
			fieldname: "mode_of_payment",
			label: __("طريقة السداد"),
			fieldtype: "Link",
			options: "Mode of Payment",
		},
		{
			fieldname: "treasury_account",
			label: __("الخزنة / الحساب"),
			fieldtype: "Link",
			options: "Account",
			get_query() {
				return {
